...
class MultiheadAttention(nn.Module):
    ...
    def __init__(self, input_dimension, num_units=None, device=None):
        ...
        # Normalize
        self.bn_layer = nn.BatchNorm1d(512).to(self.device)
    ...
    def forward(self, inputs, num_heads=16, dropout_rate=0.1, is_training=True):
        ...
        # Activation
        outputs = F.softmax(outputs,2)  # num_heads*[batch_size, seq_length, seq_length]
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        #print ("self.embedded_input is", self.embedded_input.shape)
        # Batch Normalization
        #print (self.embedded_input.shape)
        self.enc = self.embedded_input#self.bn_layer2(#)
        ...
        #print ("encoder_output is,", self.encoder_output.shape)
